...
decoratedByReactome <- OmicsON::decorateByReactomeData(
    chebiMoleculesDf = dataToVignetteEvaluation, 
...
If you want to know how to traverse through data in decorated structure? I will present it on example. Moste importan is to understand that many cells include list of vectors! Example will show also what mapping to Ensemble can give different results than mapping to UniProt:
